...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link dropdown-btn <?php  if($segment == 'bnpencemaran') {echo " ";} else {echo "collapsed";}   ?> "
                href="#">
        ...
        <li class="nav-item">
            <a class="nav-link  <?php  if($segment == 'indexair') {echo " ";} else {echo "collapsed";}   ?>"
                href="/indexair">
        ...
        <li class="nav-item">
            <a class="nav-link  <?php  if($segment == 'statusair') {echo " ";} else {echo "collapsed";}   ?>"
                href="/statusair">
