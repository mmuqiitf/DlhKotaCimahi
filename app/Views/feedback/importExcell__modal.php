    ...
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content custom__modal">
            <div class="modal-body custom__modal__content custom__modal__content__excell ">
                ...
                <input class="form-control <?= ($validation->hasError('file_excel')) ? 'is-invalid' : ''; ?>" name="file_excel" type="file" accept=".xlsx, .xls">
                <small class="text-danger justify-content-end">
                    <?= $validation->getError('file_excel'); ?>
                </small>
                <div class="button__container__modal">
                    <button class="button__excell"><i class="bi bi-check-lg icon__confirm" type="submit"></i>Import Now</button>
                    <button type="button" class="button__excell" data-bs-dismiss="modal"><i class="bi bi-x-lg icon__dismiss"></i>Tidak</button>
                </div>
            </div>
        </div>
    </div>
