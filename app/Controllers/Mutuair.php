...
class Mutuair extends BaseController
{
    ...
    public function delete_tss1($id_tikpan){
        $data=$this->Titikpantau->searchBy('id_tikpan',$id_tikpan);
        $this->Titikpantau->delete($data);
        session()->setFlashdata('success', 'Data berhasil dihapus', $data);
        return redirect()->to('/mutuair');
    }
